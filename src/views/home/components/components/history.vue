<template>
  <div class="search-suggestion">
    <div class="noHistory" v-if="historyList.length === 0">暂无搜索记录</div>
    <div class="haveHistory" v-else>
      <!-- 最上面的历史记录和删除按钮 -->
      <van-cell title="历史记录" class="top-cell">
        <template #right-icon v-if="isDeleteIconShow">
          <van-icon
            name="delete-o"
            class="search-icon"
